...
namespace Core.Migrations
{
    ...
    [Migration("20250527190726_Adding permissions table")]
    partial class Addingpermissionstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Employee", b =>
                {
                    b.HasOne("Core.Models.Permissions", "Permission")
                        .WithOne("Employee")
                        .HasForeignKey("Core.Models.Employee", "PermissionId")
            ...
            modelBuilder.Entity("Core.Models.User", b =>
                {
                    b.HasOne("Core.Models.Permissions", "Permission")
                        .WithOne("User")
                        .HasForeignKey("Core.Models.User", "PermissionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
