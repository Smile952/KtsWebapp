    ...
    return(
        <div className={styles.login_register_form}>
            <div className={`${styles.sign_in_block} ${styles.login_register_block}`}>
                <a href='/signin' className={`${styles.sign_in_link} ${styles.login_register_link}`}>Sing In</a>
            </div>
            ...
            <div className={`${styles.sign_up_block} ${styles.login_register_block}`}>
                <a href='/signup' className={`${styles.sign_up_link} ${styles.login_register_link}`}>Sing Up</a>
            </div>
